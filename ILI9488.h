...
/*
void setPinFunctions(int8_t _CS, int8_t _DC)
{
    switch (_CS)
    {
        case 0:{
            #define toggleCSh() PIOA->PIO_SODR(1u<<8)
            break;}
        case 1:{
            #define toggleCSh() PIOA->PIO_SODR(1u<<9)
            break;}
        case 2:{
            #define toggleCSh() PIOB->PIO_SODR(1u<<25)
            break;}
        case 3:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<28)
            break;}
        case 4:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<26)
            break;}
        case 5:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<25)
            break;}
        case 6:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<24)
            break;}
        case 7:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<23)
            break;}
        case 8:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<22)
            break;}
        case 9:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<21)
            break;}
        case 10:{
            #define toggleCSh() PIOC->PIO_SODR(1u<<29)
            break;}
        case 11:{
            #define toggleCSh() PIOD->PIO_SODR(1u<<7)
            break;}
        case 12:{
            #define toggleCSh() PIOD->PIO_SODR(1u<<8)
            break;}
        case 13: {
            #define toggleCSh() PIOB->PIO_SODR(1u<<27)
            break;}
        case 14: {
            #define toggleCSh() PIOD->PIO_SODR(1u<<4)
            break;}
        case 15: {
            #define toggleCSh() PIOD->PIO_SODR(1u<<5)
            break;}
        case 16: {
            #define toggleCSh() PIOA->PIO_SODR(1u<<13)
            break;}
        case 17: {
            #define toggleCSh() PIOA->PIO_SODR(1u<<12)
            break;}
        case 18: {
            #define toggleCSh() PIOA->PIO_SODR(1u<<11)
            break;}
        case 19: {
            #define toggleCSh() PIOA->PIO_SODR(1u<<10)
            break;}
        case 20: {
            #define toggleCSh() PIOB->PIO_SODR(1u<<12)
            break;}
        case 21: {
            #define toggleCSh() PIOB->PIO_SODR(1u<<13)
            break;}
    }
}*/
#endif
